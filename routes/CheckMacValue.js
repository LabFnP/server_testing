...
exports.payoff_value = function (MerchantID, PaymentType, TotalAmount, TradeDesc,
...
exports.average_value = function (MerchantID, PaymentType, TotalAmount, TradeDesc,
                          ItemName, ReturnURL, ChoosePayment, EncryptType,
  ...
  const input = [
    ...
    { key: 'ChoosePayment', value: ChoosePayment },
    { key: 'EncryptType', value: EncryptType },
    { key: 'PeriodAmount', value: PeriodAmount },
    { key: 'PeriodType', value: PeriodType },
    { key: 'Frequency', value: Frequency },
    { key: 'ExecTimes', value: ExecTimes },
    { key: 'PeriodReturnURL', value: PeriodReturnURL },
  ];
  console.log(input);
  const orderbyalpha = input.sort((a, b) => {
    var nameA = a.key.toUpperCase(); // ignore upper and lowercase
